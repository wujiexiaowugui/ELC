...
data_folder = '/home/hnu/projects/datasets/imageNet'#os.path.join(os.path.dirname(os.path.abspath(__file__)), '../../../../datasets/imageNetdata/imagenet')
...
def get_imagenet_dataloaders(batch_size, val_batch_size, num_workers,
    ...
    sampler = None#torch.utils.data.distributed.DistributedSampler(train_set)
    train_loader = torch.utils.data.DataLoader(train_set, batch_size=batch_size, 
        shuffle=True, num_workers=num_workers, pin_memory=True)
    test_loader = get_imagenet_val_loader(val_batch_size, mean, std)
    return train_loader, test_loader, num_data,sampler
